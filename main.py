...
def train(params:argparse.Namespace):
    ...
    if True:
        ...
        all_samples = []
        for z_space in range(3,data_loader.N_imgs-3,1):# data_loader.N_imgs):  # Each slices is generated individually.
...
def main():
    ...
    parser.add_argument('--dataset_name',type=str,default="neurons",help='dataset_name')
    parser.add_argument('--gt_path',type=str,default="neurons",help='gt_path')
